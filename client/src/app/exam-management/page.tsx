...
import { CalendarClock, ClipboardList, Search, UsersRound } from "lucide-react";
...
export default function ExamManagementCoursePickerPage() {
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm font-normal text-[#7A7287]">
                  เลือกรายวิชาเพื่อสร้าง จัดตาราง และติดตามการสอบของรายวิชานั้น
                </p>
              </div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl bg-[#FAF8FF] px-4 py-3 pr-10 text-sm font-normal text-[#2F2A3A] outline-none ring-1 ring-[#E7DDF8] transition placeholder:text-[#B7AFC6] focus:ring-2 focus:ring-[#B7A3E3] sm:w-80"
                />
                <Search
                  size={18}
              ...
              {filtered.map((c) => {
                ...
                return (
                  <Link
                    ...
                    href={`/course/${c.course_offerings_id}`}
