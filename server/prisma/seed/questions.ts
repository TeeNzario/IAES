...
const COLLECTIONS: CollectionSeed[] = [
  ...
  // --- New collections for expanded courses ---
  {
    key: 'AGT-2026-MID',
    courseCode: 'AGT64-101',
    academic_year: 2026,
    title: 'กลางภาค',
    description: 'แบบทดสอบกลางภาค รายวิชา Food Processing Technology',
  },
  {
    key: 'LAW-2026-MID',
    ...
    academic_year: 2026,
    title: 'กลางภาค',
    description: 'แบบทดสอบกลางภาค รายวิชา Business Law',
  },
  {
    key: 'MED-2026-MID',
    ...
    academic_year: 2026,
    title: 'กลางภาค',
    description: 'แบบทดสอบกลางภาค รายวิชา Basic Anatomy',
  },
  {
    key: 'EDU-2026-MID',
    ...
    academic_year: 2026,
    title: 'กลางภาค',
    description: 'แบบทดสอบกลางภาค รายวิชา Educational Psychology',
  },
  {
    key: 'FE-2025-FIN',
    courseCode: 'COE64-371',
    academic_year: 2025,
    title: 'ปลายภาค',
    description: 'แบบทดสอบปลายภาค Front End Programming ปี 2025',
  },
];
...
const QUESTIONS: QuestionSeed[] = [
  ...
  // ============ Food Processing (AGT64-101) ============
  {
    externalKey: 'AGT-MID-001',
    courseCode: 'AGT64-101',
  ...
  {
    externalKey: 'AGT-MID-002',
    courseCode: 'AGT64-101',
    collectionKey: 'AGT-2026-MID',
    question_type: 'MCQ_SINGLE',
    question_text: 'HACCP ย่อมาจากอะไร',
    difficulty_param: -0.2,
    discrimination_param: 0.9,
    guessing_param: 0.25,
    knowledgeNames: [
  ...
  {
    externalKey: 'LAW-MID-001',
    courseCode: 'LAW64-101',
    collectionKey: 'LAW-2026-MID',
    question_type: 'MCQ_SINGLE',
    question_text: 'สัญญาจะสมบูรณ์ได้ต้องประกอบด้วยองค์ประกอบใด',
    difficulty_param: 0.2,
    discrimination_param: 1.2,
    guessing_param: 0.25,
    knowledgeNames: ['นักศึกษาเข้าใจหลักกฎหมายพื้นฐานเกี่ยวกับสัญญาและละเมิด'],
    choices: [
      { text: 'คำเสนอและคำสนองที่ถูกต้องตรงกัน', is_correct: true },
      { text: 'การจดทะเบียนต่อเจ้าหน้าที่', is_correct: false },
      { text: 'การมีพยานอย่างน้อย 3 คน', is_correct: false },
      { text: 'การชำระเงินมัดจำ', is_correct: false },
    ],
  },
  {
    externalKey: 'LAW-MID-002',
    courseCode: 'LAW64-101',
    collectionKey: 'LAW-2026-MID',
    question_type: 'MCQ_SINGLE',
    ...
    choices: [
      ...
      { text: 'สัญญาซื้อขาย', is_correct: false },
      { text: 'สัญญาเช่าทรัพย์', is_correct: false },
      { text: 'สัญญากู้ยืมเงิน', is_correct: false },
    ],
  },
  // ============ Basic Anatomy (MED64-201) ============
  {
    externalKey: 'MED-MID-001',
    courseCode: 'MED64-201',
    collectionKey: 'MED-2026-MID',
    question_type: 'MCQ_SINGLE',
    question_text: 'อวัยวะใดไม่ได้อยู่ในระบบทางเดินอาหาร',
    difficulty_param: -1.0,
    discrimination_param: 0.8,
    guessing_param: 0.25,
    knowledgeNames: [
    ...
    choices: [
      ...
      { text: 'ลำไส้เล็ก (Small Intestine)', is_correct: false },
      { text: 'ตับอ่อน (Pancreas)', is_correct: false },
    ],
  },
  {
    externalKey: 'MED-MID-002',
    courseCode: 'MED64-201',
    collectionKey: 'MED-2026-MID',
    question_type: 'MCQ_MULTI',
    question_text:
    ...
    choices: [
      ...
      { text: 'ย่อยอาหาร', is_correct: false },
      { text: 'กำจัดของเสียผ่านการกรองเลือด', is_correct: true },
    ],
  },
  // ============ Educational Psychology (EDU64-201) ============
  {
    externalKey: 'EDU-MID-001',
    courseCode: 'EDU64-201',
    ...
    choices: [
      ...
      { text: '0-2 ปี', is_correct: false },
      { text: '2-4 ปี', is_correct: false },
      { text: '12-15 ปี', is_correct: false },
    ],
  },
  {
    externalKey: 'EDU-MID-002',
    courseCode: 'EDU64-201',
    collectionKey: 'EDU-2026-MID',
    question_type: 'MCQ_SINGLE',
    ...
    choices: [
      ...
      { text: 'Applying (ประยุกต์ใช้)', is_correct: false },
      { text: 'Analyzing (วิเคราะห์)', is_correct: false },
    ],
  },
  // ============ Front End 2025 Final ============
  {
    externalKey: 'FE-FIN-001',
    courseCode: 'COE64-371',
    ...
    choices: [
      ...
      { text: 'แทนที่ฐานข้อมูล SQL ได้', is_correct: false },
      { text: 'รองรับการเชื่อมต่อ WebSocket โดยตรง', is_correct: false },
    ],
  },
  {
    externalKey: 'FE-FIN-002',
    courseCode: 'COE64-371',
    collectionKey: 'FE-2025-FIN',
    question_type: 'MCQ_MULTI',
    question_text:
