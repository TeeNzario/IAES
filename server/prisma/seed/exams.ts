...
const EXAMS: ExamSeed[] = [
  ...
  // --- New exams for expanded courses ---
  {
    courseCode: 'AGT64-101',
    academic_year: 2026,
    semester: 1,
    title: 'กลางภาค Food Processing',
    description: 'ข้อสอบกลางภาค ครอบคลุมการแปรรูปและการถนอมอาหาร',
    start_time: pastDate(22),
    end_time: pastDate(21),
    show_results_immediately: true,
    is_active: true,
    collectionKeys: ['AGT-2026-MID'],
  },
  {
    courseCode: 'LAW64-101',
    academic_year: 2026,
    semester: 1,
    title: 'กลางภาค กฎหมายธุรกิจ',
    description: 'ข้อสอบกลางภาค กฎหมายธุรกิจเบื้องต้น เรื่องสัญญาและละเมิด',
    start_time: pastDate(12),
    end_time: pastDate(11),
    show_results_immediately: false,
    is_active: true,
    collectionKeys: ['LAW-2026-MID'],
  },
  {
    courseCode: 'MED64-201',
    academic_year: 2026,
    semester: 1,
    title: 'กลางภาค Basic Anatomy',
    description: 'ข้อสอบกลางภาค ระบบอวัยวะในร่างกายมนุษย์',
    start_time: pastDate(8),
    end_time: pastDate(7),
    show_results_immediately: true,
    is_active: true,
    collectionKeys: ['MED-2026-MID'],
  },
  {
    courseCode: 'EDU64-201',
    academic_year: 2026,
    semester: 1,
    title: 'กลางภาค Educational Psychology',
    description: 'ข้อสอบกลางภาค จิตวิทยาการศึกษาและทฤษฎีพัฒนาการ',
    start_time: pastDate(6),
    end_time: pastDate(5),
    show_results_immediately: true,
    is_active: true,
    collectionKeys: ['EDU-2026-MID'],
  },
  {
    courseCode: 'COE64-371',
    academic_year: 2025,
    semester: 2,
    title: 'ปลายภาค Front End Programming',
    description: 'ข้อสอบปลายภาค ครอบคลุม Next.js, TypeScript และ State Management',
    start_time: pastDate(90),
    end_time: pastDate(89),
    show_results_immediately: true,
    is_active: true,
    collectionKeys: ['FE-2025-FIN'],
  },
  // Upcoming exam (status=UPCOMING) for EDU64-201
  {
    courseCode: 'EDU64-201',
    academic_year: 2026,
    semester: 1,
    title: 'ปลายภาค Educational Psychology',
    description: 'ข้อสอบปลายภาค จิตวิทยาการศึกษา',
    start_time: futureDate(15),
    end_time: futureDate(16),
    show_results_immediately: false,
    is_active: true,
    collectionKeys: ['EDU-2026-MID'],
  },
