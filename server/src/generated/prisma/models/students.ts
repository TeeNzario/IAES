...
export type studentsWhereInput = {
  ...
  facultyCode?: Prisma.IntFilter<"students"> | number
  curriculumId?: Prisma.StringFilter<"students"> | string
  title?: Prisma.StringFilter<"students"> | string
...
export type studentsScalarWhereWithAggregatesInput = {
  ...
  facultyCode?: Prisma.IntWithAggregatesFilter<"students"> | number
  curriculumId?: Prisma.StringWithAggregatesFilter<"students"> | string
  title?: Prisma.StringWithAggregatesFilter<"students"> | string
...
export type studentsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"student_code" | "email" | "password_hash" | "facultyCode" | "curriculumId" | "title" | "first_name" | "last_name" | "is_active" | "created_at" | "updated_at", ExtArgs["result"]["students"]>
...
export interface studentsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `student_code`
   * const studentsWithStudent_codeOnly = await prisma.students.findMany({ select: { student_code: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Students and only return the `student_code`
   * const studentsWithStudent_codeOnly = await prisma.students.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Students and only return the `student_code`
   * const studentsWithStudent_codeOnly = await prisma.students.updateManyAndReturn({
   *   select: { student_code: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface studentsFieldRefs {
  ...
  readonly facultyCode: Prisma.FieldRef<"students", 'Int'>
  readonly curriculumId: Prisma.FieldRef<"students", 'String'>
  readonly title: Prisma.FieldRef<"students", 'String'>
